...
input_file = os.path.join(script_dir, 'Crimes_-_2001_to_Present_20260104.csv')
...
cols_to_keep = ['Date', 'Primary Type', 'Description', 'Location Description',
...
# Read first 750K rows only (FAST!)
df = pd.read_csv(input_file, nrows=750000, usecols=cols_to_keep)
